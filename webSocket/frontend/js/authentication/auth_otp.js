...
async function toggleOtpStatus()
{
	let f_username = {
		username: getCookie("username")
	};
...
async function getOtpStatusPw(f_log) {
...
async function getOtpStatusToken() {
...
async function sendOtp(connect_user)
{
/*
...
async function to_otpForm(connect_user)
{
